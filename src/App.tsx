...
function App() {
  ...
  const closeTransientLayers = () => { setMenuItem(null); setLyrics(null); setQueueOpen(false); setPlayerExpanded(false); setDetail(null); setPlaylist(null); setInfoItem(null); };
